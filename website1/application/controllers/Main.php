           ...
           $config = Array(
            ...
            if ($this->form_validation->run() == FALSE) {   
                ...
                if($this->user_model->isDuplicate($this->input->post('email'))){
                    ...
                    $message = '';                     
                    $message .= '<strong>Thank you for signed up with our website</strong><br>';
                    $message .= '<strong>Please click:</strong> ' . $link;                          
 
                    $toEmail = $this->input->post('email');
                    $to = $toEmail; # undefine 
                    $this->email->clear();
                    $this->email->from('IShip@gmail.com');
                    $this->email->to($to);
                    ...
                    {       
                         //echo "Pass <br>";        
                       $this->session->set_flashdata('flash_message', 'Please check your email for verification');
                        redirect(site_url('/main/login'));
                    }
                };              
            }
